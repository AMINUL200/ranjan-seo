          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-[#94A3B8] text-lg mt-6 max-w-lg">
                ...
                We help businesses rank higher, attract more visitors, and convert leads into customers.
              </p>
              ...
              <div className="flex items-center gap-6 mt-8">
                <div className="flex -space-x-2">
                  {[1,2,3,4].map((i) => (
                    <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-[#06B6D4] to-[#2563EB] border-2 border-white/30"></div>
                  ))}
                </div>
                <p className="text-[#94A3B8]">
                  <span className="text-white font-bold">500+</span> businesses trust us
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-16">
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl transition">
              ...
              <h3 className="text-xl font-bold text-[#0F172A] mt-6">10+ Years Experience</h3>
              <p className="text-[#475569] mt-3">
                Over a decade of mastering SEO algorithms and delivering consistent results for our clients.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl transition">
              ...
              <h3 className="text-xl font-bold text-[#0F172A] mt-6">Data-Driven Approach</h3>
              <p className="text-[#475569] mt-3">
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-lg hover:shadow-xl transition">
              ...
              <h3 className="text-xl font-bold text-[#0F172A] mt-6">Expert Team</h3>
              <p className="text-[#475569] mt-3">
                Certified SEO specialists committed to staying ahead of industry trends.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#F8FAFC]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl lg:text-4xl font-bold text-[#0F172A]">
              Comprehensive{' '}
              <span className="text-[#2563EB]">SEO Services</span>
            </h2>
            <p className="text-[#475569] mt-4 text-lg">
            ...
            {[
              {
                ...
                description: "Identify high-value keywords that drive targeted traffic to your site."
              },
              {
                icon: <BarChart3 className="text-[#2563EB]" size={32} />,
                title: "On-Page SEO",
                description: "Optimize your website structure and content for better rankings."
              },
              {
                icon: <Globe className="text-[#2563EB]" size={32} />,
                title: "Off-Page SEO",
                description: "Build quality backlinks to establish domain authority."
              },
              {
              ...
              },
              {
                ...
                description: "Track progress with detailed monthly performance reports."
              },
              {
              ...
              <div key={index} className="bg-white p-6 rounded-xl border border-gray-100 shadow-md hover:shadow-lg transition group">
                <div className="w-14 h-14 bg-[#2563EB]/10 rounded-lg flex items-center justify-center group-hover:scale-110 transition">
                  {service.icon}
                </div>
                <h3 className="text-lg font-bold text-[#0F172A] mt-4">{service.title}</h3>
                <p className="text-[#475569] mt-2 text-sm">{service.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-[#475569] mt-4 text-lg">
                Get a free SEO audit and consultation. Our experts will analyze your website and provide actionable insights.
              </p>
              ...
              <div className="space-y-4 mt-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#0F172A] font-semibold">+1 (555) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#0F172A] font-semibold">hello@seopro.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[#0F172A] font-semibold">123 SEO Street, Digital City, DC 12345</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-xl">
              <h3 className="text-2xl font-bold text-[#0F172A]">Send us a message</h3>
              <p className="text-[#475569] mt-2">We'll get back to you within 24 hours</p>
              ...
              <form className="mt-6 space-y-4">
                ...
                <button className="w-full bg-[#2563EB] text-white px-6 py-3 rounded-lg hover:bg-[#1D4ED8] transition shadow-lg font-semibold" style={{ boxShadow: '0 4px 14px rgba(37,99,235,0.35)' }}>
                  Send Message
                </button>
              </form>
            </div>
